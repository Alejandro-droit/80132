...
<head>
    ...
    <title>Galería - IE Néstor Gastañadui Sánchez</title>
...
<body>
    ...
    <section class="container mt-5 mb-5">
        <h2 class="text-center text-primary mb-4">Galería de Imágenes</h2>
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/galeria1.jpg" class="card-img-top" alt="Actividad escolar 1">
                    <div class="card-body">
                        <p class="card-text">Actividad recreativa en el patio principal.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/galeria2.jpg" class="card-img-top" alt="Actividad escolar 2">
                    <div class="card-body">
                        <p class="card-text">Participación en desfile por Fiestas Patrias.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/galeria3.jpg" class="card-img-top" alt="Actividad escolar 3">
                    <div class="card-body">
                        <p class="card-text">Estudiantes en talleres de arte y cultura.</p>
                    </div>
                </div>
            </div>
        </div>
