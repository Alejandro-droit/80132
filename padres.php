...
<head>
    ...
    <title>Atención a Padres - IE Néstor Gastañadui Sánchez</title>
...
<body>
    ...
    <section class="container mt-5">
        <h2 class="text-center text-primary mb-4">Atención a Padres</h2>
        <p class="text-center">Utilice este formulario para justificar inasistencias o reportar situaciones importantes relacionadas con su hijo(a).</p>

        <form class="mt-4">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="nombrePadre" class="form-label">Nombre del Padre/Madre o Apoderado</label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="tutor" class="form-label">Seleccione al Tutor</label>
                    <select class="form-select" id="tutor" onchange="completarDatosTutor()" required>
                        <option selected disabled>Elija un tutor</option>
                        <option value="1">Prof. Ana Pérez</option>
                        <option value="2">Prof. Juan Torres</option>
                        <option value="3">Prof. Rosa Martínez</option>
                    </select>
                </div>
                <div class="col-md-3">
            ...
            <div class="mb-3">
                <label for="motivo" class="form-label">Motivo del mensaje</label>
                <select class="form-select" id="motivo" required>
                    <option selected disabled>Seleccione una opción</option>
                    <option value="inasistencia">Justificación de Inasistencia</option>
                    <option value="queja">Reporte de bullying o conflicto</option>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="mensaje" rows="4" placeholder="Describa el motivo o situación..." required></textarea>
            </div>
