...
<head>
  ...
  <title>Proyectos - IE Néstor Gastañadui Sánchez</title>
...
<body>
  ...
  <section class="container mt-5 mb-5">
    <h2 class="text-center text-primary mb-4">Proyectos Escolares</h2>
    <p class="text-center">Una mirada a los proyectos educativos, científicos y sociales que desarrollan nuestros estudiantes a lo largo del año escolar.</p>
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="img/proyecto1.jpg" class="card-img-top" alt="Proyecto educativo 1">
          <div class="card-body">
            <h5 class="card-title">Huerto Escolar</h5>
            <p class="card-text">Iniciativa ambiental y de aprendizaje donde los alumnos cultivan vegetales y aprenden sobre sostenibilidad.</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <img src="img/proyecto2.jpg" class="card-img-top" alt="Proyecto educativo 2">
          <div class="card-body">
            <h5 class="card-title">Revista Científica</h5>
            <p class="card-text">Publicación semestral con artículos de investigación y experimentos desarrollados por estudiantes.</p>
          </div>
        </div>
      </div>
    </div>
