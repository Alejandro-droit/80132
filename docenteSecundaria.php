...
<head>
  ...
  <title>Plana Docente - IE Néstor Gastañadui Sánchez</title>
...
<body>
  ...
  <section class="container mt-5">
    <h2 class="text-center text-primary mb-5">Nuestra Plana Docente</h2>

    <div class="nivel-title">Nivel Secundaria</div>
    <div class="row">
      <div class="col-md-6">
        <div class="docente-card">
          <img src="img/docente1.jpg" alt="Prof. Ana Pérez" class="docente-img">
          <div class="docente-info">Prof. Ana Pérez<br>1er Grado</div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="docente-card">
          <img src="img/docente2.jpg" alt="Prof. Juan Torres" class="docente-img">
          <div class="docente-info">Prof. Juan Torres<br>2do Grado</div>
        </div>
      </div>
    </div>
  </section>
