...
<head>
    ...
    <title>Periódico Mural - IE Néstor Gastañadui Sánchez</title>
...
<body>
    ...
    <section class="container mt-5 mb-5">
        <h2 class="text-center text-primary mb-4">Periódico Mural</h2>
        <p class="text-center">Publicaciones recientes realizadas por los estudiantes y docentes. Un espacio para expresar creatividad, logros y actividades importantes de la comunidad educativa.</p>
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <img src="img/mural1.jpg" class="card-img-top" alt="Mural educativo 1">
                    <div class="card-body">
                        <h5 class="card-title">Semana de la Ciencia</h5>
                        <p class="card-text">Resumen de experimentos, descubrimientos y exposiciones elaboradas por nuestros alumnos.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <img src="img/mural2.jpg" class="card-img-top" alt="Mural educativo 2">
                    <div class="card-body">
                        <h5 class="card-title">Efemérides y Valores</h5>
                        <p class="card-text">Contenido mensual de fechas importantes y mensajes que refuerzan los valores institucionales.</p>
                    </div>
                </div>
            </div>
        </div>
