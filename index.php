...
<head>
  ...
  <title>IE Néstor Gastañadui Sánchez - Shiracmaca</title>
...
<body>
  ...
  <div class="carousel-container">
    <div class="welcome-message">
      <h2>Bienvenidos a la IE Néstor Gastañadui Sánchez</h2>
      <p class="lead">Formando estudiantes con valores, compromiso y excelencia en Shiracmaca.</p>
    </div>
    <div id="carouselInicio" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/fachada.jpg" class="d-block w-100" alt="Imagen 1" />
        </div>
        <div class="carousel-item">
          <img src="img/486576501_1188728346258868_3943330868784330701_n.jpg" class="d-block w-100" alt="Imagen 2" />
        </div>
        <div class="carousel-item">
          <img src="img/486661669_1188406742957695_7555241773769760905_n.jpg" class="d-block w-100" alt="Imagen 3" />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Ceremonia de apertura con participación de docentes, estudiantes y padres.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Campeonato Interescolar</h5>
            <p class="card-text">Participación destacada de nuestros equipos en disciplinas deportivas.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Semana de la Ciencia</h5>
            <p class="card-text">Exposición de experimentos y proyectos por parte de los estudiantes.</p>
          </div>
        </div>
      </div>
    </div>
