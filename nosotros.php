...
<head>
  ...
  <title>Nuestra Institución - IE Néstor Gastañadui Sánchez</title>
...
<body>
  ...
  <header class="bg-maiz text-center text-white py-5">
    <div class="container">
      <h1 class="display-5">Nuestra Institución</h1>
      <p class="lead">Formando estudiantes con valores y excelencia en Shiracmaca</p>
    </div>
  </header>
  ...
  <section class="container py-5">
    <div class="row align-items-center">
      <div class="col-md-6">
        <img src="img/fachada.jpg" alt="Colegio" class="img-fluid rounded">
      </div>
      <div class="col-md-6">
        <h3 class="text-azul">Quiénes Somos</h3>
        <p>Somos la Institución Educativa "Néstor Gastañadui Sánchez" ubicada en la comunidad de Shiracmaca. Nos dedicamos a brindar una educación integral desde nivel primaria hasta secundaria, enfocada en la formación académica y en valores.</p>
        <p>Contamos con una plana docente comprometida y moderna infraestructura que permite el desarrollo pleno de nuestros estudiantes.</p>
      </div>
    </div>

    <div class="row mt-5">
      <div class="col-md-4">
        <h4 class="text-azul">Misión</h4>
        <p>Formar estudiantes líderes con valores, pensamiento crítico y sentido de responsabilidad social.</p>
      </div>
      <div class="col-md-4">
        <h4 class="text-azul">Visión</h4>
        <p>Ser una institución educativa referente en calidad educativa y compromiso con la comunidad.</p>
      </div>
      <div class="col-md-4">
        <h4 class="text-azul">Valores</h4>
        <ul>
          <li>Respeto</li>
