...
<head>
    ...
    <title>Horarios - Nivel Secundario</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Horarios - Nivel Primaria</h2>
        <p class="text-center mb-5">Descarga los horarios académicos por grado y sección.</p>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">1° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">1° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">2° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">2° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">3° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">3° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">4° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">4° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">5° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">5° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">6° Año Sección "A"</h5>
                        <p class="card-text">Horario académico del primer año "A".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">6° Año Sección "B"</h5>
                        <p class="card-text">Horario académico del primer año "B".</p>
                        <a href="documentos/horario_1secundaria.pdf" class="btn btn-primary" download>Descargar</a>
                    </div>
                </div>
